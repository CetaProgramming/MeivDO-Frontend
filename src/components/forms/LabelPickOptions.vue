    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-3 justify-around">
            <div class="flex gap-10">
                <ButtonIcon @click.stop.prevent="changeValue(1, $event)" class="flex flex-col items-center text-black dark:text-white " :bg="this.value == 1 ? 'bg-blue-600' : 'bg-zinc-300 dark:bg-zinc-700' "
                :text="text[0]" icon="fa-solid fa-thumbs-up"></ButtonIcon>
                <ButtonIcon @click.stop.prevent="changeValue(0, $event)" class="flex flex-col items-center text-black dark:text-white"  :bg="this.value == 0 ? 'bg-MeivRed' : 'bg-zinc-300 dark:bg-zinc-700' "
